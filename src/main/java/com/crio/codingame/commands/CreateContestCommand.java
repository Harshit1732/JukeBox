...
public class CreateContestCommand implements ICommand{
    ...
    @Override
    public void execute(List<String> tokens) throws ContestNotFoundException,UserNotFoundException,QuestionNotFoundException {
        ...
        try {
            ...
            if (tokens.size() == 5) {
                numOFQuestion = tokens.get(4);
                Contest contest= contestService.create(contestName, Level.valueOf(level), contestCreator, Integer.parseInt(numOFQuestion));
        ...
        } catch (ContestNotFoundException | UserNotFoundException | QuestionNotFoundException e) {
